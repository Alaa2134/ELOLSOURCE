...
export const DEFAULT_SETTINGS = {
  ...
  // متجر التجار: كلمة سر بتحوّل أسعار المتجر لـ "سعر المخزن" — من غير ما تظهر أي مسميات
  store: {
    storePassword: '9988', // لما التاجر/العميل يكتبها في المتجر، الأسعار تيجي من خانة "سعر المخزن"
    showOnInvoice: true, // نطبع QR ولينك المتجر وكلمة السر على الفاتورة
  },
  wa: {
    gatewayUrl: '',
    token: '',
